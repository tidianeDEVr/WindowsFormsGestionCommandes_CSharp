...
namespace WindowsFormsGestionCommandes {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class commandeDataTable : global::System.Data.TypedTableBase<commandeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public commandeRow AddcommandeRow(string date, int montant, int client_id) {
        ...
        public partial class commandeRow : global::System.Data.DataRow {
            ...
            public string date {
                get {
                    try {
                        return ((string)(this[this.tablecommande.dateColumn]));
                    }
            ...
            public int montant {
                get {
                    return ((int)(this[this.tablecommande.montantColumn]));
                }
                set {
...
namespace WindowsFormsGestionCommandes.masterDataSetTableAdapters {
    ...
    public partial class commandeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[commande] WHERE (([ID] = @Original_ID) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ([montant] = @Original_montant) AND ((@IsNull_client_id = 1 AND [client_id] IS NULL) OR ([client_id] = @Original_client_id)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[commande] ([date], [montant], [client_id]) VALUES (@date, @mon" +
                "tant, @client_id);\r\nSELECT ID, date, montant, client_id FROM commande WHERE (ID " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[commande] SET [date] = @date, [montant] = @montant, [client_id] = @client_id WHERE (([ID] = @Original_ID) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ([montant] = @Original_montant) AND ((@IsNull_client_id = 1 AND [client_id] IS NULL) OR ([client_id] = @Original_client_id)));
SELECT ID, date, montant, client_id FROM commande WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsGestionCommandes.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, date, montant, client_id FROM dbo.commande";
        ...
        public virtual int Fill(masterDataSet.commandeDataTable dataTable) {
        ...
        public virtual masterDataSet.commandeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.commandeDataTable dataTable = new masterDataSet.commandeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.commandeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_date, int Original_montant, global::System.Nullable<int> Original_client_id) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_montant));
        ...
        public virtual int Insert(string date, int montant, global::System.Nullable<int> client_id) {
            if ((date == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(montant));
        ...
        public virtual int Update(string date, int montant, global::System.Nullable<int> client_id, int Original_ID, string Original_date, int Original_montant, global::System.Nullable<int> Original_client_id, int ID) {
            if ((date == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(montant));
            if ((client_id.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_montant));
            if ((Original_client_id.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string date, int montant, global::System.Nullable<int> client_id, int Original_ID, string Original_date, int Original_montant, global::System.Nullable<int> Original_client_id) {
            return this.Update(date, montant, client_id, Original_ID, Original_date, Original_montant, Original_client_id, Original_ID);
        }
    }
